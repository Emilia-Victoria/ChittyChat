...
func (x *Chatty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Chatty) ProtoMessage() {}

func (x *Chatty) ProtoReflect() protoreflect.Message {
	mi := &file_chat_chat_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Chatty.ProtoReflect.Descriptor instead.
func (*Chatty) Descriptor() ([]byte, []int) {
...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x09, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x22, 0x22, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41, 0x63, 0x6b,
	0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x08, 0x0a, 0x06, 0x43, 0x68, 0x61, 0x74, 0x74, 0x79,
	0x32, 0x9c, 0x01, 0x0a, 0x0a, 0x43, 0x68, 0x69, 0x74, 0x74, 0x79, 0x43, 0x68, 0x61, 0x74, 0x12,
	0x33, 0x0a, 0x0e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x63, 0x6b, 0x22, 0x00, 0x12, 0x2b, 0x0a, 0x08, 0x6a, 0x6f, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x74,
	0x12, 0x0c, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x74, 0x79, 0x1a, 0x0d,
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x30,
	0x01, 0x12, 0x2c, 0x0a, 0x09, 0x6c, 0x65, 0x61, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x12, 0x0c,
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x74, 0x79, 0x1a, 0x0d, 0x2e, 0x63,
...
var file_chat_chat_proto_goTypes = []interface{}{
	...
	(*Chatty)(nil),     // 2: chat.Chatty
}
var file_chat_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChittyChat.publishMessage:input_type -> chat.Message
	2, // 1: chat.ChittyChat.joinChat:input_type -> chat.Chatty
	2, // 2: chat.ChittyChat.leaveChat:input_type -> chat.Chatty

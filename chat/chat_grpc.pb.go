...
type ChittyChatClient interface {
	...
	JoinChat(ctx context.Context, in *Chatty, opts ...grpc.CallOption) (ChittyChat_JoinChatClient, error)
	LeaveChat(ctx context.Context, in *Chatty, opts ...grpc.CallOption) (ChittyChat_LeaveChatClient, error)
}
...
func (c *chittyChatClient) JoinChat(ctx context.Context, in *Chatty, opts ...grpc.CallOption) (ChittyChat_JoinChatClient, error) {
...
func (c *chittyChatClient) LeaveChat(ctx context.Context, in *Chatty, opts ...grpc.CallOption) (ChittyChat_LeaveChatClient, error) {
...
type ChittyChatServer interface {
	...
	JoinChat(*Chatty, ChittyChat_JoinChatServer) error
	LeaveChat(*Chatty, ChittyChat_LeaveChatServer) error
...
func (UnimplementedChittyChatServer) JoinChat(*Chatty, ChittyChat_JoinChatServer) error {
	return status.Errorf(codes.Unimplemented, "method JoinChat not implemented")
}
func (UnimplementedChittyChatServer) LeaveChat(*Chatty, ChittyChat_LeaveChatServer) error {
